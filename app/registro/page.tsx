    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-[420px] flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-1 text-center">
          ...
          <p className="text-sm text-[#A0A0A0]">Empieza gratis, sin tarjeta de crédito</p>
        </div>
        ...
        <p className="text-xs text-[#555] text-center leading-relaxed">
          ...
          <a href="/terminos" className="text-[#A0A0A0] hover:text-white underline underline-offset-2 transition-colors duration-150">
            Términos y condiciones
          </a>{" "}
          y{" "}
          <a href="/privacidad" className="text-[#A0A0A0] hover:text-white underline underline-offset-2 transition-colors duration-150">
        ...
        <a
          href="/app"
          className="w-full py-3.5 bg-white text-black font-bold text-sm rounded-xl hover:bg-gray-100 active:bg-gray-200 transition-colors duration-150 text-center"
        >
          Crear cuenta
        </a>
