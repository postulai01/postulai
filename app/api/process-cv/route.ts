...
- sugerencias: array de exactamente 3 strings, cada una con el formato "Título breve: acción concreta", donde el título tiene 2 a 4 palabras y el total (título + descripción) no supera 20 palabras. Al menos una debe referirse al aspecto más relevante de la oferta que el candidato no tiene actualmente, formulada como algo a desarrollar o mencionar con interés en la entrevista, nunca afirmando que ya lo domina
