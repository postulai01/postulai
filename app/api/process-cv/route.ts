...
□ 10. Integridad de afirmaciones: antes de entregar, revisa cada habilidad, competencia o afirmación de formación que aparece en el perfil profesional y en los bullets. Por cada una, señala mentalmente la línea exacta del CV original que la respalda. Si no existe esa línea → elimínala o reformúlala únicamente como algo en desarrollo activo (solo si el CV original menciona cursos, ramos o experiencia directamente relacionada). Nunca afirmar competencias ya consolidadas sin evidencia directa en el CV original. Ejemplo de lo que NO está permitido: si el CV dice "Mención en Finanzas Cuantitativas" pero no menciona cursos, proyectos o herramientas específicas de modelado financiero, NO puedes escribir "formación sólida en modelado financiero" — eso es inferencia, no evidencia. Solo puedes mencionar lo que está escrito literalmente en el CV original, nunca lo que "probablemente" sabe alguien con esa mención.
