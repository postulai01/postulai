    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-[420px] flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-1 text-center">
          <h1 className="text-2xl font-black tracking-tight">Bienvenido de vuelta</h1>
          <p className="text-sm text-[#A0A0A0]">Ingresa a tu cuenta para continuar</p>
        </div>
        ...
        <p className="text-center text-sm text-[#A0A0A0]">
          ¿No tienes cuenta?{" "}
          <a href="/registro" className="text-white font-semibold hover:opacity-70 transition-opacity duration-150">
            Regístrate
          </a>
        </p>
